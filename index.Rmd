...
ggplot(raceth_unemp_yr, aes(x = year)) +
  geom_errorbar(aes(ymin = white/100, ymax = black/100), color = "gray50", 
                alpha = 0.75) +
  geom_line(aes(y = (black - white)/100), color = "orange", size = 1.25) +
  ...
  labs(title = "Black unemployment has always been higher than white unemployment
       ...
       caption = "Source: Bureau of Labor Statistics Current Population Survey") +
  annotate(geom = "errorbar", x = 1998, ymin = 0.18, ymax = 0.195, 
           color = "gray50") +
  annotate(geom = "text", x = 2004, y = 0.195, label = "Black unemployment",
           size = 3.5) +
  annotate(geom = "text", x = 2004, y = 0.18, label = "White unemployment",
           size = 3.5) +
  annotate(geom = "line", x = c(2010, 2012), y = rep(0.1875, 2), color = "orange",
           size = 1.25) +
  annotate(geom = "text", x = 2016, y = 0.1875, label = "Black-white gap", size = 3.5)
```
