...
```{r industry_data_prep, include=FALSE, echo=FALSE, fig.width=15}
#===============================================================================#
...
```{r unemployment_map, message=FALSE, warning=FALSE, error=FALSE, fig.width = 15, fig.height=11}
...
ggplot(aes(x = adj_urate/100,
  ...
  labs(title = "Unemployment stayed high in many counties well after the end \nof the official recession",
...
```{r alternative_measures, fig.width=10, fig.height=7, message='hide'}
